...
//    	TraverseMode[] modes = new TraverseMode[] { TraverseMode.CAR, TraverseMode.WALK }; 
        ...
        trips.forEach(t -> log.debug(t.toString()));
...
//    	TraverseMode[] modes = new TraverseMode[] { TraverseMode.CAR, TraverseMode.WALK }; 
    	...
    	leg1.setLegGeometryEncoded(new EncodedPolylineBean("_al|Hm_xf@?U?WHe@D_AF{@?QAQEW[iAs@@", null, 11));
    	...
    	leg3.setLegGeometryEncoded(new EncodedPolylineBean("sb{|Hwwjf@Rz@@LATAFHD\\\\P??DDJg@CAf@iC", null, 12));
    	...
    	leg4.setLegGeometryEncoded(new EncodedPolylineBean("e_{|Hqyjf@}b@lcCk{@n|K}e@|rC{]hfCwIxe@gOxZqoEz|EkKdTgy@laC_Mn_BtHjzB|GzQz~@xqA", null, 14));
    	...
    	leg5.setLegGeometryEncoded(new EncodedPolylineBean("arg}Ho_yd@Pj@p@bDCBBHA@EDw@n@{@f@A@KQOa@I]_A_FgB~@QoAc@wCCKCIEIw@gACCG?_Aj@k@XODGw@gA\\\\Gk@XK", null, 30));
