...
import eu.netmobiel.planner.model.OtpLocatedEntity_;
...
//    }
    ...
    public List<OtpCluster> findImportantHubs(GeoLocation fromPlace, GeoLocation toPlace, Geometry area, int minNrRoutes, TraverseMode[] modes, int maxResults) {
        ...
        Predicate spatialAreaPred = cb.isTrue(cb.function("st_within", Boolean.class, clusters.get(OtpLocatedEntity_.location).get(GeoLocation_.point), cb.literal(area))); 
