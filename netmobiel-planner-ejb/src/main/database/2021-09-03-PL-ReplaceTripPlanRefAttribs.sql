...
ALTER TABLE public.trip_plan
    ...
    ADD CONSTRAINT trip_plan_reference_itinerary_itinerary_uc UNIQUE (reference_itinerary_itinerary),
	ADD CONSTRAINT trip_plan_reference_itinerary_itinerary_fk FOREIGN KEY (reference_itinerary_itinerary)
