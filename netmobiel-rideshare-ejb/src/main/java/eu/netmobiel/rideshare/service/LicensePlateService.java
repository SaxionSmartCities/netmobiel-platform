...
public class LicensePlateService {
    ...
    public Car fetchLicensePlateInformation(String country, String plate) throws IOException, ObjectNotFoundException {
		Car car = null;
    	...
    	if (car == null) {
    		throw new ObjectNotFoundException(String.format("No car found with license %s %s", country.toUpperCase(), plate.toUpperCase()));
    	} else {
