...
import eu.netmobiel.geoservice.api.resource.SuggestionsResource;
...
public class GeoApplication extends Application {
    ...
    @Inject
    private GeoVersion version;

    @PostConstruct
    public void postConstruct() {
        StringBuilder builder = new StringBuilder();
        builder.append("\n------------------------------------------------");
        builder.append("\nStarting up Netmobiel Geo REST Service");
    ...
    public Set<Class<?>> getClasses() {
        ...
        resources.add(SuggestionsResource.class);
