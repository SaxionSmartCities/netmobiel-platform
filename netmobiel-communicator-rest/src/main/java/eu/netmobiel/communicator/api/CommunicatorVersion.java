 ...
 */
@ApplicationScoped
public class CommunicatorVersion extends Version {

	public CommunicatorVersion() {
		super(CommunicatorVersion.class.getClassLoader(), "eu/netmobiel/communicator/version.properties");
	}
