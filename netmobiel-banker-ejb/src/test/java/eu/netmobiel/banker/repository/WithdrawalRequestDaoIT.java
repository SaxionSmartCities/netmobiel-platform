...
//   		System.out.println(archive.toString(true));
    ...
    protected void insertData() throws Exception {
    	...
    	dummyTransaction1 = ledger.createStartTransaction("description-1", "ref-1", Instant.parse("2020-04-07T17:00:00Z"), Instant.parse("2020-04-07T18:00:00Z"))
    	...
    	dummyTransaction2 = ledger.createStartTransaction("description-2", "ref-2", Instant.parse("2020-04-07T17:00:00Z"), Instant.parse("2020-04-07T18:00:00Z"))
    			.credit(balance1, 10, TransactionType.PAYMENT, balance2.getAccount())
    			.debit(balance2, 10, TransactionType.PAYMENT, balance1.getAccount())
    			.build();
    	em.persist(dummyTransaction2);
    	dummyTransaction3 = ledger.createStartTransaction("description-3", "ref-3", Instant.parse("2020-04-07T17:00:00Z"), Instant.parse("2020-04-07T18:00:00Z"))
    			.credit(balance1, 10, TransactionType.PAYMENT, balance2.getAccount())
    			.debit(balance2, 10, TransactionType.PAYMENT, balance1.getAccount())
    			.build();
