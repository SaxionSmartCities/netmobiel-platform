 ...
 */
@ApplicationScoped
public class ProfileServiceVersion extends Version {

	public ProfileServiceVersion() {
		super(ProfileServiceVersion.class.getClassLoader(), "eu/netmobiel/profile/version.properties");
	}
